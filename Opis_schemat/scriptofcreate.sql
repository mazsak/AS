    ...
    create table BULL (
       ID_BULL integer not null auto_increment,
        NAME_ varchar(255),
        primary key (ID_BULL)
    ) engine=InnoDB

    create table CALVING (
       ID_CALVING integer not null auto_increment,
        CALVING_DATE date,
        NOTES varchar(255),
        ID_CALF integer,
        ID_CATTLE integer,
    ...
    create table CATTLE (
       ID_CATTLE integer not null auto_increment,
        BIRTH_DATE date,
    ...
    create table COWSHED (
       ID_COWSHED integer not null auto_increment,
        ADDRESS varchar(255),
        INFO varchar(255),
        NAME_ varchar(255),
    ...
    create table INSEMINATION (
       ID_INSEMINATION integer not null auto_increment,
    ...
    create table MEDICINE (
       ID_MEDICINE integer not null auto_increment,
        NAME_ varchar(255),
    ...
    create table MEDS_USED (
       ID_MEDICINE integer not null,
        ...
        DOSE varchar(255),
        primary key (ID_MEDICINE, ID_TREATMENT)
    ) engine=InnoDB

    create table STATS_DAILY (
       ID_DAILY integer not null auto_increment,
        MILK_AMOUNT integer,
        MILKING_DATE date,
        MILKING_TIME time,
        ID_CATTLE integer,
    ...
    create table STATS_MONTHLY (
       ID_MONTHLY integer not null auto_increment,
    ...
    create table TREATMENT (
       ID_TREATMENT integer not null auto_increment,
        DISEASE varchar(255),
        END_DATE date,
        NOTES varchar(255),
        START_DATE date,
